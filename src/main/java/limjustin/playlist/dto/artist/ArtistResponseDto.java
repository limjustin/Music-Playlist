...
public class ArtistResponseDto {  // 조회 용도 DTO 객체
    ...
    private List<ArtistResponseDto> responseDtoList = new ArrayList<>();

    public ArtistResponseDto(Long id, String name, Type type, Genre genre, byte[] profileImg) {  // Entity to DTO
        this.id = id;
        this.name = name;
        this.type = type;
        this.genre = genre;
